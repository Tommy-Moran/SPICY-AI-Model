...
|---|---|---|
| `aha_chest_pain_2021.pdf` | 2021 AHA/ACC/ASE/CHEST/SAEM/SCCT/SCMR Chest Pain Guideline | Yes — obtain from publisher |
| `aha_cad_2021.pdf` | 2021 ACC/AHA/SCAI Coronary Artery Revascularization Guideline | Yes — obtain from publisher |
| `ccs_dyslipidemia_2021.pdf` | 2021 Canadian Cardiovascular Society Dyslipidemia Guideline | Yes — obtain from publisher |
...
## Prompt vs knowledge-base note

The archived SPICY-AI system prompt (`../prompt.txt`) historically instructs the model to
cross-reference eTG Cardiovascular Guidelines. eTG was **not** one of the four documents
indexed in the study knowledge base. Treat that prompt clause as an ungrounded instruction
rather than evidence that eTG content was retrieved. The GPT-4o comparator prompt is archived
at `../gpt4o_prompt.txt`.
